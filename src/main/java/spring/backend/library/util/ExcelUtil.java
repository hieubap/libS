...
//import vn.isofh.common.exception.ExcelException;
...
//      throw new ExcelException.InvalidFileExtension(XLSX_EXTENSION, path.getFileName().toString());
//    }
//
...
//      }
//
//      Path logFile = FileUtil.addSuffix(path, "_log");
//
...
//      return logFile;
//    } catch (IOException e) {
//      throw new StorageException.FailedToStoreFile(path.getFileName().toString(), e);
//    } finally {
//      try {
