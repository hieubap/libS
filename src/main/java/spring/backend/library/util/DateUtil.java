...
public final class DateUtil {
  ...
  public static Integer getDaysBetween(ZonedDateTime from, ZonedDateTime to) {
    ...
    return NumberUtil.toInteger(ChronoUnit.DAYS.between(from, to));
  }
  ...
  public static Integer getMonthsBetween(ZonedDateTime from, ZonedDateTime to) {
    ...
    return NumberUtil.toInteger(ChronoUnit.MONTHS.between(from, to));
  }
  ...
  public static Integer getAgeMonths(ZonedDateTime from, ZonedDateTime to) {
    ...
    Integer months = NumberUtil.toInteger(ChronoUnit.MONTHS.between(from, to));
    if (months == 0) {
      return 1;
    }
  ...
  public static Integer getYearsBetween(ZonedDateTime from, ZonedDateTime to) {
    ...
    return NumberUtil.toInteger(ChronoUnit.YEARS.between(from, to));
  }
  ...
  public static ZonedDateTime parseZonedDateTime(String d, String format) {
    if (StringUtil.isBlank(d) || StringUtil.isBlank(format)) {
      return null;
    }
    ...
    try {
      ...
      LocalDateTime dateTime = parseValidDateTime(d, format);
  ...
  public static LocalDateTime parseDateTime(String d, String format) {
    ...
    try {
      ...
      LocalDate date = parseValidDate(d, format);
  ...
  public static String formatDateTime(ZonedDateTime d) {
